...
import init, { create_board, get_expected_frequencies } from "./monopoly_wasm.js";

import { perf_now, perf_end } from "./perf.js";
...
init({ module_or_path: new URL("monopoly_wasm_bg.wasm", location.href) }).then(() => {
